...
$queryHasil = mysqli_query($conn, "SELECT hk.*, jm.*, js.* FROM tb_hasil_kemiripan hk INNER JOIN tb_judul_mahasiswa jm ON hk.fk_judul_mahasiswa = jm.id_judul_mahasiswa INNER JOIN tb_judul_skripsi js ON hk.fk_judul_skripsi = js.id_judul_skripsi WHERE hk.id_hasil_kemiripan = '$id'");
			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1>Detail Hasil Kemiripan</h1>
						<div class="section-header-breadcrumb">
							<div class="breadcrumb-item active"><a href="beranda">Beranda</a></div>
							<div class="breadcrumb-item"><a href="hasil-kemiripan">Hasil Kemiripan</a></div>
							<div class="breadcrumb-item">Detail Hasil Kemiripan</div>
						</div>
					</div>
								...
								<div class="card">
									<div class="card-body">
										<form role="form" action="#" method="POST" enctype="multipart/form-data" id="data-form">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<input type="text" name="judul" id="judul" class="form-control" required="" autocomplete="off" placeholder="Judul" autofocus="" minlength="5" readonly="" style="background: #fff;" value="<?php echo $rowHasil[10];?>">
													</div>
												</div>
											</div>
											<div class="row">
											...
											<div class="row">
												<div class="col-md-12">
													<a href="hasil-kemiripan" class="btn btn-danger">Kembali</a>
												</div>
											</div>
										</form>
									</div>
