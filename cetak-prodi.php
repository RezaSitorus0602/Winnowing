...
$pdf->SetTitle('Laporan Prodi');
$pdf->SetSubject('Prodi');
$pdf->SetKeywords('TCPDF, PDF, Prodi, Laporan');
...
$pdf->AddPage();
$pdf->SetY(40);
$pdf->Write(0, 'Laporan Prodi', '', 0, 'C', true, 0, false, false, 0);
...
function fetch_data() {
	include 'koneksi.php';
	$output = '';
	$sql = "SELECT * FROM tb_prodi ORDER BY kode ASC";
...
<th align="center" style="width: 25%;"><b>NIM</b></th>
<th align="center" style="width: 70%;"><b>Nama Prodi</b></th>
</tr>';     
$content .= fetch_data(); 
$content .= '
</table>';
...
$pdf->Output('Laporan Prodi.pdf', 'I');
?>